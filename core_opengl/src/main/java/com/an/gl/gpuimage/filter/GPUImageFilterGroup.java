...
import com.an.gl.gpuimage.util.Rotation;
import com.an.gl.gpuimage.util.TextureRotationUtil;

import static com.an.gl.gpuimage.GPUImageRenderer.CUBE;
import static com.an.gl.gpuimage.util.TextureRotationUtil.TEXTURE_NO_ROTATION;
...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    /*
     * (non-Javadoc)
     * @see com.an.gl.gpuimage.filter.GPUImageFilter#onInit()
     */
    @Override
    public void onInit() {
        super.onInit();
    ...
    /*
     * (non-Javadoc)
     * @see com.an.gl.gpuimage.filter.GPUImageFilter#onDestroy()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * com.an.gl.gpuimage.filter.GPUImageFilter#onOutputSizeChanged(int,
     * int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.an.gl.gpuimage.filter.GPUImageFilter#onDraw(int,
