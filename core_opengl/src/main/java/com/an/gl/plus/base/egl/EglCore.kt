 ...
 */
class EglCore @JvmOverloads constructor(private var sharedContext: EGLContext? = null, flags: Int = 0) {
    ...
    /**
     * Creates an EGL surface associated with a Surface.（渲染到屏幕时，使用）
     *
     *
    ...
    /**
     * Creates an EGL surface associated with an offscreen buffer.(在后台渲染时， 使用)
     */
